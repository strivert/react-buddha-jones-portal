...
CREATE TABLE `dot` (
  ...
  `configuration_url` varchar(500) DEFAULT NULL,
  ...
  `sequence` bigint(22) DEFAULT NULL,
...
--
-- Table structure for table `dot_callback_url_param`
--

DROP TABLE IF EXISTS `dot_callback_url_param`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dot_callback_url_param` (
  `dot_id` int(22) NOT NULL,
  `param_name` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dot_handle`
--

DROP TABLE IF EXISTS `dot_handle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dot_handle` (
  `transaction_id` bigint(22) NOT NULL AUTO_INCREMENT,
  `handle_id` bigint(22) DEFAULT NULL,
  `token` varchar(500) DEFAULT NULL,
  `type` enum('inbound','outbound') DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`transaction_id`)
) ENGINE=InnoDB AUTO_INCREMENT=73411 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `dot_message`
--

DROP TABLE IF EXISTS `dot_message`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dot_message` (
  `id` bigint(22) NOT NULL AUTO_INCREMENT,
  `dot_id` bigint(22) DEFAULT NULL,
  `message` text,
  `created_at` datetime DEFAULT NULL,
...
-- Dump completed on 2017-04-06 23:17:55
